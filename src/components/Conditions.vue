<template>
  <div class="condition">
    ...
    <h5 style="font-style: italic">En vigueur au 31/12/20</h5>
      <p>Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique des
        modalités de mise à disposition du site et des services par Eperi&School et de définir les conditions
    ...
    <p>Toute inscription ou utilisation du site implique l'acceptation sans aucune réserve ni restriction des présentes
      ...
      https://www.e-peri-school.fr/ se réserve le droit de modifier unilatéralement et à tout moment le contenu des
      présentes CGU</p>

    <h2>Article 1 : Les mentions légales</h2>
    <p>L’édition et la direction de la publication du site https://www.e-peri-school.fr/ est assurée par
      _______________, domicilié _______________.
      Numéro de téléphone est _______________
      Adresse e-mail _______________.
      L'hébergeur du site https://www.e-peri-school.fr/ est la société _______________, dont le siège social est
      situé au _______________, avec le numéro de téléphone : _______________.</p>

    <h2>ARTICLE 2 : Accès au site</h2>
    <p>Le site https://www.e-peri-school.fr/ permet à l'Utilisateur un accès gratuit aux services suivants :
      ...
      responsabilité de https://www.e-peri-school.fr/. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur
    ...
    <p>Les sources des informations diffusées sur le site https://www.e-peri-school.fr/ sont réputées fiables mais le
      ...
      des mises à jour régulières, le site https://www.e-peri-school.fr/ ne peut être tenu responsable de la
      modification des dispositions administratives et juridiques survenant après la publication. De même, le site
      ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans ce site.
      ...
      Le site https://www.e-peri-school.fr/ ne peut être tenu pour responsable d’éventuels virus qui pourraient
    ...
    <p>Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces liens,
      il sortira du site https://www.e-peri-school.fr/. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles
    ...
    <p>L’Utilisateur est informé que lors de ses visites sur le site, un cookie peut s’installer automatiquement sur
      ...
      par votre navigateur et qui sont nécessaires à l’utilisation du site https://www.e-peri-school.fr/. Les cookies
      ...
      L’information contenue dans les cookies est utilisée pour améliorer le site https://www.e-peri-school.fr/.
    ...
    <p>La législation française s'applique au présent contrat. En cas d'absence de résolution amiable d'un litige né
